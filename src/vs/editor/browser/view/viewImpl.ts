...
// import { ControlLib } from 'vs/editor/browser/viewParts/controlLib/controlLib';
...
export class View extends ViewEventHandler {
	...
	private createViewParts(): void {
		...
		// let controlLib = new ControlLib(this._context);
		// this.viewParts.push(controlLib);
		...
		// this.overflowGuardContainer.appendChild(controlLib.getDomNode());
